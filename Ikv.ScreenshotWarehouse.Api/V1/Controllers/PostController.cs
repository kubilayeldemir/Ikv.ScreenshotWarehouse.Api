...
namespace Ikv.ScreenshotWarehouse.Api.V1.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        [HttpPost("save-test-file")]
        public async Task<IActionResult> SaveTestFile()
        {
            string filePath = $"./images/testImage.jpeg";
            var base64TestPhoto =
            ...
            System.IO.File.WriteAllBytes(filePath, Convert.FromBase64String(base64TestPhoto));
            return Ok();
        }
    }
}